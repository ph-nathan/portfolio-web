"use client";
// use client is needed because motion.div (framer motion) is using useEffect for the animation
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <motion.span
            className="absolute animate-bounce delay-500 bottom-0 right-0 text-4xl"
            initial={{ opacity: 0, scale: 0 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring",
      ...
      >
        <span className="font-bold">Hello, I'm Nhat </span> (or Nathan). I'm a{" "}
        <span className="font-bold">Software Engineer</span> and a{" "}
        <span className="font-bold">Computer Science</span> undergraduate at the{" "}
      ...
      >
        <Link
          href="#contact"
          className="group bg-gray-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focusEffect hover:bg-gray-950 transition"
          onClick = {()=> {
